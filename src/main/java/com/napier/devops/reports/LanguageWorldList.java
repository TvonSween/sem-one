 ...
 */
public class LanguageWorldList implements IUserSelectionProcessor {
    ...
    private static final Logger logger = Logger.getLogger(LanguageWorldList.class.getName());
     ...
     */
    public LanguageWorldList(String filename, String sqlQueryString) {
    ...
    public void processUserSelection(Reports report, Connection con, String userInput, String limit) {
        ...
        try {
            report.extract(rset, this.fileName, new String[]{
                    Reports.Columns.Language.toString(),
                    Reports.Columns.Population.toString(),
                    Reports.Columns.PercentageOfWorld.toString(),
                });
        } catch (Exception e) {
