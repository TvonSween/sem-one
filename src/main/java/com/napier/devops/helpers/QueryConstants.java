...
public class QueryConstants {
    ...
    public static final String CITY_POPULATION_DESC =
            "SELECT city.Name as City, country.Name, Region, city.District, city.Population " +
            "FROM country JOIN city ON country.Code = city.CountryCode ORDER BY city.Population DESC";
    public static final String CITY_POPULATION_CONTINENT_DESC =
            "SELECT city.Name as City, country.Name, Continent, city.District, city.Population " +
                     "FROM country JOIN city ON country.Code = city.CountryCode WHERE Continent = '%s' ORDER BY city.Population DESC";
    public static final String CITY_POPULATION_COUNTRY_DESC =
            "SELECT city.Name as City, country.Name, city.District, city.Population " +
                    "FROM country JOIN city ON country.Code = city.CountryCode WHERE country.Name = '%s' ORDER BY city.Population DESC";
